...
T = TypeVar("T", bound="CreateConvoreMailChannelParams")


@_attrs_define
class CreateConvoreMailChannelParams:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_convore_mail_channel_params = cls(
            sender_name=sender_name,
            address=address,
        )

        create_convore_mail_channel_params.additional_properties = d
        return create_convore_mail_channel_params
