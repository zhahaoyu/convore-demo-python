...
class UpdateConversationRequest(BaseModel):
    ...
    label_ids: Optional[List[StrictStr]] = Field(default=None, description="List of labels for this conversation")
    participants: Optional[List[MessageParticipant]] = None
    ...
    __properties: ClassVar[List[str]] = ["status", "priority", "label_ids", "participants", "subject", "snippet", "is_unread", "last_message_date"]
