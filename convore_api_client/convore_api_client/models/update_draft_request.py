...
class UpdateDraftRequest(BaseModel):
    ...
    UpdateDraftRequest
    """ # noqa: E501
    channel_id: Optional[StrictStr] = Field(default=None, description="Identifier of the channel through which the conversation is taking place.")
    ...
    __properties: ClassVar[List[str]] = ["channel_id", "from", "to", "cc", "bcc", "subject", "body", "raw_body", "sender", "recipients"]
