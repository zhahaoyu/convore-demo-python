...
class CreateDraftRequest(BaseModel):
    ...
    conversation_id: Optional[StrictStr] = Field(default=None, description="Identifier of the conversation the draft belongs to.")
    ...
    __properties: ClassVar[List[str]] = ["channel_id", "conversation_id", "reply_to_message_id", "reply_type", "from", "to", "cc", "bcc", "sender", "recipients", "subject", "body", "quote_body", "raw_body"]
