...
class CreateConnectorRequest(BaseModel):
    ...
    gmail: Optional[CreateGmailConnectorParams] = None
    ses: Optional[CreateSesConnectorParams] = None
    __properties: ClassVar[List[str]] = ["provider", "name", "gmail", "ses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "gmail": CreateGmailConnectorParams.from_dict(obj["gmail"]) if obj.get("gmail") is not None else None,
            "ses": CreateSesConnectorParams.from_dict(obj["ses"]) if obj.get("ses") is not None else None
        })
        return _obj
