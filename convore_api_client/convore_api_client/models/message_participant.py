...
class MessageParticipant(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the participant. Used to create the contact if needed.")
    handle: ContactHandle
    role: MessageParticipantRole
    __properties: ClassVar[List[str]] = ["name", "handle", "role"]
