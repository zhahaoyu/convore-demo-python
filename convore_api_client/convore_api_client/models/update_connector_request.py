...
class UpdateConnectorRequest(BaseModel):
    ...
    gmail: Optional[UpdateGmailConnectorParams] = None
    ses: Optional[UpdateSesConnectorParams] = None
    __properties: ClassVar[List[str]] = ["name", "gmail", "ses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "gmail": UpdateGmailConnectorParams.from_dict(obj["gmail"]) if obj.get("gmail") is not None else None,
            "ses": UpdateSesConnectorParams.from_dict(obj["ses"]) if obj.get("ses") is not None else None
        })
        return _obj
