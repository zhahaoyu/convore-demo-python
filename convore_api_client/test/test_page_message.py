...
class TestPageMessage(unittest.TestCase):
    """PageMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageMessage:
        """Test PageMessage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageMessage`
        """
        model = PageMessage()
        if include_optional:
            return PageMessage(
                data = [
                    convore_api_client.models.message.Message(
